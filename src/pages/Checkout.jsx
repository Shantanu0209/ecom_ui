    ...
    return (
      <div className="container my-5 py-5">
        <div className="row justify-content-center">
          <div className="col-md-6 text-center bg-light p-5 rounded shadow-sm">
            <h4 className="display-5 mb-4">No items in your cart</h4>
      ...
      <>
        <div className="container py-5">
          <div className="row gy-4">
              ...
              <div className="card shadow-sm rounded-4 border-0">
                ...
                <div className="card-body">
                  <ul className="list-group list-group-flush">
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center border-0 px-0 mt-3 pt-3 border-top">
                      <div>
                        <strong>Total amount</strong>
                      </div>
            ...
            <div className="col-md-7 col-lg-8">
              <div className="card shadow-sm rounded-4 border-0">
                <div className="card-header py-3 bg-white rounded-top">
                  <h4 className="mb-0">Billing Address</h4>
                </div>
                <div className="card-body">
                  <form className="needs-validation" noValidate>
